...
class ContractData(BaseModel):
    # StructuredContractData.java 와 필드 동기화
    leaseType: str | None = Field(None, description="임대 유형")
    location: str | None = Field(None, description="소재지")
    landType: str | None = Field(None, description="토지 지목")
    landArea: float | None = Field(None, description="토지 면적")
    buildingStructureUse: str | None = Field(None, description="건물 구조/용도")
    buildingArea: float | None = Field(None, description="건물 면적")
    leasePart: str | None = Field(None, description="임대할 부분")
    leaseArea: float | None = Field(None, description="임대 면적")
    ...
    commissionAmount: int | None = Field(None, description="중개보수 금액")
    ...
    lessorName: str | None = Field(None, description="임대인 성명")
    lessorAddress: str | None = Field(None, description="임대인 주소")
    lessorIdNumber: str | None = Field(None, description="임대인 주민등록번호")
    lessorPhone: str | None = Field(None, description="임대인 전화번호")
    lessorAgentAddress: str | None = Field(None, description="임대인 대리인 주소")
    lessorAgentIdNumber: str | None = Field(None, description="임대인 대리인 주민번호")
    lessorAgentName: str | None = Field(None, description="임대인 대리인 성명")
    lesseeName: str | None = Field(None, description="임차인 성명")
    lesseeAddress: str | None = Field(None, description="임차인 주소")
    lesseeIdNumber: str | None = Field(None, description="임차인 주민등록번호")
    lesseePhone: str | None = Field(None, description="임차인 전화번호")
    lesseeAgentAddress: str | None = Field(None, description="임차인 대리인 주소")
    lesseeAgentIdNumber: str | None = Field(None, description="임차인 대리인 주민번호")
    lesseeAgentName: str | None = Field(None, description="임차인 대리인 성명")
    realtorOfficeAddress1: str | None = Field(None, description="공인중개사 사무소 소재지(좌측)")
    realtorOfficeAddress2: str | None = Field(None, description="공인중개사 사무소 소재지(우측)")
    realtorOfficeName1: str | None = Field(None, description="공인중개사 사무소 명칭(좌측)")
    realtorOfficeName2: str | None = Field(None, description="공인중개사 사무소 명칭(우측)")
    realtorSignature1: str | None = Field(None, description="대표 서명 및 날인(좌측)")
    realtorSignature2: str | None = Field(None, description="대표 서명 및 날인(우측)")
    realtorLicensePhone1: str | None = Field(None, description="등록번호 및 전화번호(좌측)")
    realtorLicensePhone2: str | None = Field(None, description="등록번호 및 전화번호(우측)")
    realtorAgentSignature1: str | None = Field(None, description="소속공인중개사 서명(좌측)")
    realtorAgentSignature2: str | None = Field(None, description="소속공인중개사 서명(우측)")
