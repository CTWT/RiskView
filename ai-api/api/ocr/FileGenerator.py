...
test_dataset = [
    LeaseContract(
        ...
        commissionAmount=10,
        specialTerms='임차인이 개인 사정(이사, 직장 이동 등)으로 계약 기간 중도 해지를 원할 경우, 위약금 없이 계약을 해지할 수 있다.',
    ...
    LeaseContract(
        ...
        commissionAmount=15,
        specialTerms='임차인의 과실로 인한 손상은 임차인 부담, 자연 노후에 따른 손상은 임대인 부담',
    ...
    LeaseContract(
        ...
        commissionAmount=5,
        specialTerms='임대차 기간 중 발생하는 모든 시설물(수도, 보일러 등)의 고장·수리·교체 비용은 임차인이 전액 부담한다.',
