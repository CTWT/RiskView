        ...
        switch (featureId) {
            ...
            case "riskAnalysis":
                return {
                    ...
                    description: (
                        <>
                            최신 AI 기술을 활용하여 부동산 계약서의 모든 조항을
                            면밀히 분석합니다.
                            <br />
                            숨겨진 불리한 조건, 애매한 표현, 법적 위험 요소를
                            자동으로 탐지하여 안전한 거래를 도와드립니다.
                        </>
                    ),
                    features: [
                        {
            ...
            case "unusualTransaction":
                return {
                    ...
                    description: (
                        <>
                            국토교통부 실거래가 데이터와 AI 분석을 통해 시세
                            대비 비정상적인 거래 가격을 실시간으로 감지합니다.
                            <br />
                            과도한 금액이나 의심스러운 저가 거래를 미리 파악할
                            수 있습니다.
                        </>
                    ),
                    features: [
                        {
                            ...
                            title: "실시간 시세 비교",
                            description:
                                "주변 지역 최근 실거래가와 즉시 비교 분석",
                        },
                        {
                            icon: <div className="circle-icon"></div>,
                            title: "이상 거래 알림",
                            description:
                                "시세 대비 차이나는 거래에 대한 경고 알림",
                        },
                        {
                            icon: <div className="circle-icon"></div>,
                            title: "시장 동향 분석",
                            description:
                                "해당 지역의 가격 상승/하락 트렌드 및 전망 제공",
                        },
                    ],
                    ...
                    features: [
                        {
                            ...
                            title: "4개 언어 지원",
                            description:
                                "분석 한 계약서를 리포트를 통해 다양한 언어로 제공",
                        },
                        {
                            icon: <div className="circle-icon"></div>,
                            title: "법률 용어 번역",
                            description:
                                "복잡한 법률 용어도 번역하여 이해하기 쉽게 제공",
                        },
                    ],
            ...
            case "community":
                return {
                    ...
                    description: (
                        <>
                            실제 부동산 거래를 경험했거나 처음인 사용자들이
                            자유롭게 정보를 나누는 공간입니다.
                            <br />
                            계약 시 주의할 점, 지역별 특징, 리스크 사례 등
                            다양한 주제를 함께 이야기하며,
                            <br />
                            서로의 경험을 통해 안전하고 현명한 의사결정을 도울
                            수 있습니다.
                        </>
                    ),
                    features: [
            ...
            case "legalLexicon":
                return {
                    ...
                    description: (
                        <>
                            부동산 계약서를 읽다가 이해되지 않는 법률 용어가
                            있다면,
                            <br />
                            누구나 쉽게 검색하고 의미를 바로 확인할 수 있도록
                            도와주는 용어 사전입니다.
                        </>
                    ),
                    features: [
